...
def main():
    ...
    parser.add_argument("--snapshot",
                        choices=("development", "installation", "native-history", "relay-close", "effort", "usage", "output-styles", "tool-images", "client-version", "measured-client"),
                        default="development",
                        help="select the frozen D78, D79, D87, D96, D99, D101, D108, D109, D110–D112 or D113 artifact record")

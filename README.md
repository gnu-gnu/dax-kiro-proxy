...
reaches an installed development artifact (D127); consult DEVELOPMENT_STATUS.md for verified
...
Phase 7 has frozen dependency inventories and retained scoped notices. For the installed D127
development artifact, run `python3 tools/verify_dependency_inventory.py
--gomodcache .cache/gomod --snapshot progress-setup --binary dist/dax-kiro-proxy`. The default
...
identifies D125; `measured-client-269` identifies D126.

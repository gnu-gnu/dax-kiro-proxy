...
(2.1.268 since D124, 2.1.267 since D113; D110 admits same-major builds without new measurement), not
full Anthropic API parity. D33 inventories implemented behavior; D52 records the delivery policy.

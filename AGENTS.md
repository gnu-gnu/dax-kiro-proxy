...
Before merging a feature, run the applicable tests from `ACCEPTANCE_SPEC.md`. Before the first release,
complete the license and dependency review in `CLEAN_ROOM_BOUNDARY.md`, select a language using
`LANGUAGE_DECISION.md`, and record the decision.

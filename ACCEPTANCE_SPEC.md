...
D114 records the same directed exception for Kiro: a main/helper pair reporting one build whose major
version equals the measured pin's is admitted, reported as unmeasured, and runs the measured policy;
